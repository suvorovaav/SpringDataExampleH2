package com.example.springdataexampleh2.security;

import com.example.springdataexampleh2.details.EmployeeDetailsServiceImpl;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/hello-employee").hasAnyRole("EMPLOYEE")
